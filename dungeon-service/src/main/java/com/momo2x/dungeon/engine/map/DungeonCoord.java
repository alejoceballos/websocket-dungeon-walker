...
public record DungeonCoord(int x, int y) {
    ...
    public DungeonCoord getCoordAt(DungeonDirectionType direction) {
    ...
    public DungeonDirectionType calculateDirection(final DungeonCoord coord) {
        ...
        return coordDirection.isEmpty() ? null : DungeonDirectionType.valueOf(coordDirection.toString());
    }
